    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="glass-card p-6 border-t-2 border-t-aegis-red">
            <div className="flex items-center gap-3 mb-5">
              <Flame className="w-5 h-5 text-aegis-red" />
            ...
            <div className="space-y-4 text-sm">
              <p className="text-xs text-aegis-gray leading-relaxed">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  <label className="text-xs text-aegis-gray font-semibold uppercase">
                    Target Service
                  </label>
                  <select
                    value={testService}
                    onChange={(e) => setTestService(e.target.value)}
                    className="w-full bg-aegis-darker border border-aegis-border text-white text-xs rounded-lg p-2.5 focus:outline-none focus:border-aegis-cyan/50"
                  >
              ...
              <button
                ...
                className="w-full py-2.5 bg-aegis-red hover:bg-aegis-red/90 disabled:opacity-50 text-white font-bold rounded-lg text-xs transition-colors flex items-center justify-center gap-1.5 uppercase tracking-wide"
              >
                {triggerLoading ? 'Triggering...' : 'Fire Incident Webhook'}
              </button>

              {triggerResult && (
                <div className="p-3 bg-aegis-green/10 border border-aegis-green/20 rounded-lg text-xs font-mono text-aegis-green">
          ...
          <div className="glass-card p-6 border-t-2 border-t-aegis-purple">
            <div className="flex items-center gap-3 mb-5">
              <Activity className="w-5 h-5 text-aegis-purple" />
              <h4 className="font-bold text-sm uppercase tracking-wide">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  disabled={dbLoading}
                  className="py-2.5 border border-aegis-red/30 hover:border-aegis-red/50 bg-aegis-red/5 hover:bg-aegis-red/10 text-aegis-red font-semibold rounded-lg text-xs transition-all flex items-center justify-center gap-2 uppercase tracking-wide"
                >
                ...
                <button
                  ...
                  disabled={dbLoading}
                  className="py-2.5 border border-aegis-cyan/30 hover:border-aegis-cyan/50 bg-aegis-cyan/5 hover:bg-aegis-cyan/10 text-aegis-cyan font-semibold rounded-lg text-xs transition-all flex items-center justify-center gap-2 uppercase tracking-wide"
                >
        ...
        <div className="space-y-6">
          ...
          <div className="glass-card p-6 border-t-2 border-t-aegis-cyan">
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-3">
                <Radio className="w-5 h-5 text-aegis-cyan" />
                <h4 className="font-bold text-sm uppercase tracking-wide">
                  ShopStream Service Status
                </h4>
              </div>
              <div className="flex items-center gap-1.5 text-xs text-aegis-gray">
            ...
            {shopStatus ? (
              <div className="space-y-4">
                ...
                {shopStatus.chaos_active ? (
                  <div className="p-4 bg-aegis-red/10 border border-aegis-red/20 rounded-lg flex items-center gap-3 text-aegis-red">
                    <AlertOctagon className="w-6 h-6 animate-pulse" />
                    <div>
                      <h5 className="font-bold text-xs uppercase tracking-wide">
                        Chaos Injection Active
                      </h5>
                      <p className="text-[11px] text-aegis-gray mt-0.5">
                        Checkout service is currently returning artificial 500 errors.
                      </p>
                    </div>
                  </div>
                ) : (
                  <div className="p-4 bg-aegis-green/10 border border-aegis-green/20 rounded-lg flex items-center gap-3 text-aegis-green">
                ...
                {/* Details */}
                <div className="grid grid-cols-2 gap-4 bg-aegis-darker/50 p-4 rounded-lg border border-aegis-border font-mono text-xs">
                  <div>
                    <span className="text-aegis-gray">Active Rate:</span>{' '}
                    <span className={shopStatus.chaos_active ? 'text-aegis-red font-bold' : 'text-gray-300'}>
                      {shopStatus.chaos_active ? `${shopStatus.errorRate}% Errors` : '0%'}
                    </span>
                  </div>
                  <div>
                    <span className="text-aegis-gray">Time Remaining:</span>{' '}
              ...
              <div className="p-12 text-center text-xs text-aegis-gray">
          ...
          <div className="glass-card p-6 border-t-2 border-t-aegis-yellow">
            <div className="flex items-center gap-3 mb-5">
              <Flame className="w-5 h-5 text-aegis-yellow" />
              <h4 className="font-bold text-sm uppercase tracking-wide">
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-xs font-semibold">
                  <span className="text-aegis-gray uppercase">Error Intensity</span>
                  <span className="text-aegis-yellow">{errorRate}% HTTP 500s</span>
                </div>
                <input
                  type="range"
                  min="10"
                  ...
                  className="w-full h-1 bg-aegis-darker rounded-lg appearance-none cursor-pointer accent-aegis-yellow border border-aegis-border"
                />
              </div>

              {/* Duration selection */}
              <div className="space-y-2">
                <span className="text-xs text-aegis-gray font-semibold uppercase block">
                  Outage Duration
                </span>
                  ...
                  {[60, 120, 240].map((t) => (
                    <button
                      ...
                      className={`flex-1 py-1.5 rounded-lg border text-xs font-semibold ${
                        duration === t
                          ? 'border-aegis-yellow bg-aegis-yellow/10 text-aegis-yellow'
                          : 'border-aegis-border bg-aegis-darker hover:text-white'
                      }`}
                    >
                      {t} seconds
                    </button>
              ...
              <div className="flex gap-4 pt-2">
                <button
                  ...
                  className="flex-1 py-2.5 bg-aegis-yellow hover:bg-aegis-yellow/90 disabled:opacity-50 text-aegis-darker font-bold rounded-lg text-xs transition-colors uppercase tracking-wide"
                >
                  Inject Failure
                </button>
                ...
                <button
                  ...
                  disabled={chaosLoading}
                  className="flex-1 py-2.5 border border-aegis-green bg-aegis-green/5 hover:bg-aegis-green/10 text-aegis-green font-bold rounded-lg text-xs transition-colors uppercase tracking-wide"
                >
                  Stop Chaos / Restore
                </button>
              </div>
